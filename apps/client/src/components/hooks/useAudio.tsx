...
import { audioBufferAtom, audioDataURLAtom, promptAtom, voiceAtom } from "../model/UserAtom"
...
const useAudio = () => {
    ...
    useEffect(() => {
        const parse = async () => {
            ...
            const audioBuffer = await new AudioContext().decodeAudioData(parsedIntArray.buffer)
